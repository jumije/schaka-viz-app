...
1. Use the `Data Lab` in the sidebar to create your dataset. Choose a scenario or set custom parameters, then click `Generate/Update Dataset`.
...
# --- Dataset Explanation ---
with st.expander("📋 Click here to learn about the **Datasets** the Data Lab simulates!"):
    st.markdown("""
...
with st.expander("🎛️ Click here to learn about the **Parameters** the Data Lab uses!"):
    st.markdown("""
